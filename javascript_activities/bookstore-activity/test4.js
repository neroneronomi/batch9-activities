...
class Stores {
    ...
    sellItem(item, quantity) {
        ...
        if (found === undefined) {
            ...
            console.log(`${quantity} ${item} is successfully sold for ${quantity * price}`);
        } else if (quantity > found.quantity) {
...
bookStore.addItem('CSS for Dummies', 0, 100);
bookStore.addItem('JS for Dummies', 0, 100);
...
bookStore.sellItem('HTML for Dummies', 5)
